...
import org.iota.wallet.var.TorUtil;
...
import org.iota.wallet.var.send.JSONRPC.JSONRPC;
            ...
            if(ConnectivityStatus.hasConnectivity(context)) {
                ...
                try {
                    ...
                    if(!jsonObject.has("process"))    {
                        showAlertDialog(context.getString(R.string.messages_api_error), false);
                    }
                ...
                showAlertDialog(context.getString(R.string.messages_network_error), false);
            }
